...
//       PANEL_SPACING: 120,
//       INGREDIENT_HOVER: 1.2 // Scale multiplier on hover
//     };
//   }

//   // Universal scaling method - maintains aspect ratio
...
//   // Alternative scaling - fills entire space (may crop)
//   scaleToFill(sprite, targetWidth, targetHeight) {
...
//   // Smart scaling based on image type and context
...
//     // Adjust for context (hover, selected, etc.)
//     if (context === 'hover') {
//       targetSize = {
...
//     // Re-setup elements with new sizes
...
//     const centerY = this.cameras.main.height / 2 + 50; // Slightly lower to account for UI
    
//     // Main cauldron with consistent sizing
...
//     // Visual indicator for drop zone (initially invisible)
//     this.dropZoneGraphics = this.add.graphics();
    
//     // Brewing sequence display
...
//     // Collect all ingredients needed for current level
...
//       // Create ingredient container background
...
//       const nameText = this.add.text(x, y + 50, INGREDIENTS[ingredientKey].name, {
//         fontSize: '12px',
//         fill: '#ffffff',
//         align: 'center',
//         backgroundColor: 'rgba(0, 0, 0, 0.7)',
...
//         stroke: '#880808',
//     strokeThickness: 3,
//     // resolution: window.devicePixelRatio || 2 // Handle high-DPI displays
//       }).setOrigin(0.5);
      
//       // Rarity indicator with consistent sizing
//       const rarityColors = {
//         common: '#ffffff',
//         uncommon: '#00ff00',
//         rare: '#0080ff',
...
//         6, 
//         Phaser.Display.Color.HexStringToColor(rarityColors[INGREDIENTS[ingredientKey].rarity]).color
...
//         `Required: ${this.currentRecipe.ingredients.join(' → ')}${progressText}`
//       ).setVisible(true);
//     }
//   }
...
//         if (!dropped) {
//           // Return to original position if not dropped in cauldron
//           gameObject.setPosition(
//             gameObject.getData('originalX'),
//             gameObject.getData('originalY')
//           );
...
//     // Animate falling into cauldron
//     this.tweens.add({
//       targets: fallingSprite,
//       x: this.cauldron.x,
//       y: this.cauldron.y,
//       scale: fallingSprite.scaleX * 0.5, // Scale down as it falls
//       alpha: 0.5,
//       duration: 500,
//       ease: 'Power2',
//       onComplete: () => {
...
//   createBrewingEffect() {
//     // Scaled particle effects based on cauldron size
...
//     // Scale spark effects to cauldron size
...
//     // Change cauldron glow based on ingredients added
...
//     // Change glow color based on recipe
...
//     // Add gentle pulsing animation scaled to cauldron size
//     this.tweens.add({
...
//     // Reset for next potion after delay
...
//   createSuccessEffect() {
//     // Explosion of colorful particles scaled to cauldron
...
//   failPotion() {
//     // Failure effect - smoke and red particles scaled to cauldron
...
//     // Stop any existing tweens on cauldron glow
...
//     // Setup new level with responsive sizing
//     this.handleResize();
//     this.setupIngredientPanels();
...
//       // Quick reset if brewing failed
//       if (this.ingredientSequence.length > 0 && !this.isBrewingComplete) {
//         this.resetCauldron();
//       }
//     });
//   }
...
import * as Phaser from 'phaser';
import { RECIPES, LEVEL_REQUIREMENTS } from '@/components/potion_brew/data/recipes';
import { INGREDIENTS } from '@/components/potion_brew/data/ingredients';
...
export default class MainGameScene extends Phaser.Scene {
  ...
  setupUI() {
    ...
    // Create pause button
    // this.pauseButton = this.add.text(200, 50, '⏸️ Pause', {
    //   fontSize: '16px',
    //   fontFamily: 'Arial, sans-serif',
    //   fill: '#ffffff',
    ...
    // .setDepth(1000)
    // .on('pointerover', () => {
    //   this.pauseButton.setStyle({ backgroundColor: '#e0a800' });
    //   this.pauseButton.setScale(1.05);
    // })
    // .on('pointerout', () => {
    //   this.pauseButton.setStyle({ backgroundColor: '#ffc107' });
